...
if not defined BOXM2_OPENCL_DIR set BOXM2_OPENCL_DIR=/vxl/share/vxl/cl/boxm2/
...
if not defined VIP_POSTGRESQL_CREDENTIALS set VIP_POSTGRESQL_CREDENTIALS=-U %VIP_POSTGRESQL_USER% -h %VIP_POSTGRESQL_DOCK_HOST% -p %VIP_POSTGRESQL_DOCK_PORT%
if not defined VIP_POSTGRESQL_SERVER_CREDENTIALS set VIP_POSTGRESQL_SERVER_CREDENTIALS=-h %VIP_POSTGRESQL_DOCK_HOST% -p %VIP_POSTGRESQL_DOCK_PORT%
