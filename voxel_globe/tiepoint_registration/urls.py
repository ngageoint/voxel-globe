...
urlpatterns = [
    ...
    url(r'^tiepoint_error/(?P<image_set_id>\d+)/(?P<camera_set_id>\d+)$', views.tiepoint_error_3, name="tiepoint_error_3"),
    url(r'^tiepoint_error/(?P<image_set_id>\d+)/(?P<camera_set_id>\d+)/(?P<scene_id>\d+)$', views.tiepoint_error_4, name="tiepoint_error_4"),
    ...
    url(r'^tiepoint_registration/(?P<image_set_id>\d+)/(?P<camera_set_id>\d+)$', views.tiepoint_registration_3, name="tiepoint_registration_3"),
]